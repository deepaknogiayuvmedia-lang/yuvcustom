                ...
                <div class="col-md-4">
                    <div class="graphicards">
                        <div class="card-body text-start">
                            ...
                            <p class="card-text text-start text-wrap">Our graphic design services are essential for creating
                ...
                <div class="col-md-4">
                    <div class="graphicards">
                        <div class="card-body text-start">
                            ...
                            <p class="card-text text-start text-wrap">User Interface (UI) and User Experience (UX) design is
