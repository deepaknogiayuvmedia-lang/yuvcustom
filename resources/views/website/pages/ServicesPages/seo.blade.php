...
@section('content')
    ...
    <section class="position-relative">
        <div class="container  py-3 py-md-5">
            <div class=" row">
                <div class="text-center seoheading text-capitalize">
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="text-start seoheadingsectiontwo">
                        Elevate Your Online Presence with <span
                            class=" seoheadingsubsectiontwo text-decoration-underline">Expert SEO</span>
                    </div>
