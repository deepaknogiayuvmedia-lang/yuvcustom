...
@section('content')
<section style="background-color: #f5f9ff;" class="py-5">
        ...
        <div class=" row">
            <div class="col-md-6">
                ...
                <div class="d-flex justify-content-start flex-wrap buttonsdiv">
                    <div class="me-3">
                        <a href="#" class="btn btn-lg gmbbtn">Get Started for Free <i class="bi bi-arrow-right"></i></a>
                    </div>
                    <div class="mt-3 mt-md-0">
                        <a class="btn btn-outline-dark btn-lg bookdemobtngmb" href="#">Book a Demo</a>
                    </div>
                </div>
            </div>
...
<section style="background-image: url('{{ asset('assets/websiteAssets/images/gmbbackgorund png o.jpg') }}'); background-repeat: repeat;" class="py-5">
        ...
        <div class="row gy-4 gx-4">
            <div class="col-md-4">
                <div class="gmbcardone">
                    <div class="card-body">
                        <img src="{{ asset('assets/websiteAssets/images/presence.png') }}" alt="service bg" class="mb-3"
            ...
            <div class="text-center py-2">
                ...
                Feel the impact of YUVMEDIA GMB Services and elevate your business to new heights while you concentrate on what you do best.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container py-5 justify-content-center">
        <div class="row">
            ...
            <div class="text-center py-2">
                ...
                Maximize your local business potential with a fully optimized Google My Business profile. From keyword analysis to strategic audits and engaging campaigns, we ensure your business stands out in local search results.
                </p>
            </div>
        </div>
        <div class="row gy-4 gx-4">
            <div class="col-md-3">
                <div class="gmbcardssecthree">
                    <div class="card-body text-start">
                        <img src="{{ asset('assets/websiteAssets/images/competitive-analysis.png') }}" alt="service bg" class="mb-3"
                            style="width: 60px; height: 60px; object-fit: contain;">
                        <p class="fw-bold text-start">Keyword and Competitor Analysis</p>
                        <p class="card-text text-start text-wrap">We analyze your competitors' GMB and optimize your GMB with keywords to improve you ranking.</p>
                        <!-- <a href="#" class="btn whatcardbtn">Know More</a> -->
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="gmbcardssecthree">
                    <div class="card-body text-start">
                        <img src="{{ asset('assets/websiteAssets/images/audit.png') }}" alt="service bg" class="mb-3"
                            style="width: 60px; height: 60px; object-fit: contain;">
                        <p class="fw-bold text-start">Audit Of GMB Listing</p>
                        <p class="card-text text-start text-wrap">Our professionals conduct multiple GMB listing audits to develop a strategy for your business growth.</p>
                        <!-- <a href="#" class="btn whatcardbtn">Know More</a> -->
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="gmbcardssecthree">
                    <div class="card-body text-start">
                        <img src="{{ asset('assets/websiteAssets/images/social-marketing.png') }}" alt="service bg" class="mb-3"
                            style="width: 60px; height: 60px; object-fit: contain;">
                        <p class="fw-bold text-start">Executing Campaign</p>
                        <p class="card-text text-start text-wrap">High-quality citations with contextual links for your business. and make GMB profile for target audience.</p>
                        <!-- <a href="#" class="btn whatcardbtn">Know More</a> -->
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="gmbcardssecthree">
                    <div class="card-body text-start">
                        <img src="{{ asset('assets/websiteAssets/images/monthly-reporting.png') }}" alt="service bg" class="mb-3"
                            style="width: 60px; height: 60px; object-fit: contain;">
                        <p class="fw-bold text-start">Weekly and Monthly Reporting</p>
                        <p class="card-text text-start text-wrap">We transparently work with our clients, providing them with weekly and monthly reports of their insights.</p>
                        <!-- <a href="#" class="btn whatcardbtn">Know More</a> -->
                    </div>
                </div>
            </div>
