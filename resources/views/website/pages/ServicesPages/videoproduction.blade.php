...
@section('content')
    ...
    <section class="pb-5 position-relative herosection ">
        ...
        <div class="container bannersection">
            <div class="row py-5">
                ...
                <div class="subTitle">
                    Fusion of Technology and Creativity <br/>
                    Timely Delivery <br/>
    ...
    <section class="py-4 position-relative" style="z-index: 9">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    ...
                    <div class="d-flex justify-content-start flex-wrap buttonsdiv">
                        <div class="me-3">
                            <a href="{{ route('contact') }}" class="btn btn-lg videoprobbtn">Contact Us<i
                                    class="bi bi-arrow-right ms-3"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <img class="videoprobimage"
                        src="{{ asset('assets/websiteAssets/images/services/video-maker-editing-movie.webp') }}"
                        alt="">
                </div>
            </div>
        </div>
            ...
            <div class="row gy-4 gx-4">
                <div class="col-md-4">
                    <div class="videoprocardone">
                        <div class="card-body text-start">
                            ...
                            <p class="card-text text-start text-wrap">Present your brand's story, values, and achievements
                                through professional corporate videos.</p>
                ...
                <div class="col-md-4">
                    <div class="videoprocardssecthree">
                        <div class="card-body text-start">
                            <img src="{{ asset('assets/websiteAssets/images/video-marketing.png') }}" alt="service bg"
                                class="mb-3" style="width: 60px; height: 60px; object-fit: contain;">
                            <p class="fw-normal text-start">Promotional Videos</p>
                            <p class="card-text text-start text-wrap">Highlight your services or products with engaging
                                promotional videos to attract customers.</p>
                            <!-- <a href="#" class="btn whatcardbtn">Know More</a> -->
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="videoprocardone">
                        <div class="card-body text-start">
                            <img src="{{ asset('assets/websiteAssets/images/events.png') }}" alt="service bg" class="mb-3"
                                style="width: 60px; height: 60px; object-fit: contain;">
                            <p class="fw-normal text-start">Event Coverage</p>
                            <p class="card-text text-start text-wrap">Capture the important moments of your events with
                                thorough video coverage, including all functions.</p>
                            <!-- <a href="#" class="btn whatcardbtn">Know More</a> -->
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="videoprocardssecthree">
                        <div class="card-body text-start">
                            ...
                            <p class="card-text text-start text-wrap">Create a stronger online presence with short,
                                powerful
                                videos for all social platforms.</p>
                            <!-- <a href="#" class="btn whatcardbtn">Know More</a> -->
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="videoprocardone">
                        <div class="card-body text-start">
                            ...
                            <p class="card-text text-start text-wrap">Create informative videos to train your employees or
                                educate your audience effectively.</p>
                            <!-- <a href="#" class="btn whatcardbtn">Know More</a> -->
                        </div>
                    </div>
                </div>
