    ...
    <div class="container py-5">
        <div class=" row">
            ...
            <div class="d-flex justify-content-center flex-wrap">
                <div class="me-3">
                    <a href="#" class="btn btn-lg whatbtn">Get Started for Free <i class="bi bi-arrow-right"></i></a>
                </div>
                <div class="mt-3 mt-md-0">
                    <a class="btn btn-outline-dark btn-lg bookdemobtnwhat" href="#">Book a Demo</a>
                </div>
            </div>
        </div>
    </div>
...
<section style="background-color: whitesmoke;" class="py-5">
    <div class="container-fluid">
        <div class="row gy-3">
            <div class="col-lg-4">
                <img class="img-fluid whatimgs rounded-3"
        ...
        <div class="row">
            ...
            <div class="text-center fs-5">
                <p class="text-wrap whywhatcontent">
                     WhatsApp serves as the ultimate platform that seamlessly combines actionable notifications with reliable customer support, enabling businesses to stay connected with their audience while enhancing engagement and satisfaction!
                </p>
            </div>
        </div>
