            ...
            <div class="col-md-6">
                ...
                <div class="text-start py-2">
                    <ul class="list-group list-group-flush" style="list-style: none;">
                        <li class="py-2">Fill out our brief contact form, and we’ll contact you soon to learn more
                            about your business.</li>
                        <li class="py-2">Our digital marketing experts will work closely with you to implement
                            data-driven strategies that drive business growth.</li>
                        <li class="py-2">Solidify your digital presence, expand your brand reach, and see outstanding
                            results month-over-month.</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-6">
