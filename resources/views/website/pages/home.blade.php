        ...
        <div class="row">
            <div class="col-md-3">
                <div class="servicecard">
                    <img src="{{ asset('assets/websiteAssets/images/serviceCard.png')}}" alt="service bg" class="servicebg">
                    <img src="{{ asset('assets/websiteAssets/images/advertising.png')}}" alt="icon image" class="serviceIcon">
            ...
            <div class="col-md-3">
                <div class="servicecard">
                    <img src="{{ asset('assets/websiteAssets/images/serviceCard.png')}}" alt="first image" class="servicebg">
                    <img src="{{ asset('assets/websiteAssets/images/marketing.png')}}" alt="icon image" class="serviceIcon">
                    <div class="serviceHeading">
            ...
            <div class="col-md-3">
                <div class="servicecard">
                    <img src="{{ asset('assets/websiteAssets/images/serviceCard.png')}}" alt="first image" class="servicebg">
                    <img src="{{ asset('assets/websiteAssets/images/tools.png')}}" alt="icon image" class="serviceIcon3">
                    <div class="serviceHeading">
                        Website Development
                    </div>
                    <div class="serviceContent">
            ...
            <div class="col-md-3">
                <div class="servicecard">
                    <img src="{{ asset('assets/websiteAssets/images/serviceCard.png')}}" alt="first image" class="servicebg">
                    <img src="{{ asset('assets/websiteAssets/images/growth.png')}}" alt="icon image" class="serviceIcon">
                    <div class="serviceHeading">
