...
<x-app-layout>
                    ...
                    <div class="col-md-2 d-flex justify-content-end align-items-center">
                        <div class="">
                            <a href="{{ route('admin.casestudylists') }}" class="btn btn-outline-primary">
                                <i class="ti ti-arrow-narrow-left"></i> All Case Studies
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="#" class="form-horizontal">
                            <div class="mb-4">
                                ...
                                <input type="text" placeholder="Case Study Title" value="{{$cases->title}}" name="studytitle" class="form-control" required>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="thumbnailPreview" class="mt-3">
                                <img src="{{asset('assets/images/CaseStudies/'.$cases->caseimage)}}" alt="Thumbnail Preview" class="img-fluid rounded-3" style="max-height: 100px; display: {{$cases->caseimage ? 'block' : 'none'}};">
                            </div>
                            ...
                            <form action="#" class="form-horizontal">
                                <div>
                                    <select name="categories" class="form-select mr-sm-2  mb-2" id="inlineFormCustomSelect" required>
                                        ...
                                        <option value="{{$data->label}}" {{$data->label == $cases->category ? 'selected' : ''}}>{{$data->label}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </form>
                        ...
                        if (data.message) {
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    window.location.href = "/admin/casestudylists/";
                                }
                            });
                        } else {
                            Swal.fire({
    ...
    <script>
        ...
        const content = @json($cases['casecontent']);
        console.log(content);
