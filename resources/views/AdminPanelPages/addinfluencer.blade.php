            ...
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-2 d-flex justify-content-end align-items-center">
                        <div class="">
                            <a href="{{ route('admin.allinfluencers') }}" class="btn btn-outline-primary">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.insertInfluencer')}}" method="POST" enctype="multipart/form-data" class="rounded p-4 form-horizontal">
                            @csrf
                            <!-- Personal Details -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="tel" class="form-control" name="contactnumber" placeholder="Enter Phone/Mobile" required>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="stateinput" name="state" placeholder="Enter State">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label class="form-label">Country</label>
                                    <input type="text" class="form-control" id="countryinput" name="country" placeholder="Enter Country">
                                </div>
                            </div>
