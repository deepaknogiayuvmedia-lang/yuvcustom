...
class AdminViews extends Controller
{
    ...
    public function allinfluencers()
    {
        ...
        $data = Influencer::orderBy('created_at', 'DESC')->get();
        $cities = DB::table('influencers')
            ->select(DB::raw('LOWER(city) as city'))
            ->distinct()
            ->pluck('city');
    ...
    public function influencerscart()
    {
        ...
        $cities = DB::table('influencers')
            ...
            ->distinct()
            ->pluck('city');
        return view('AdminPanelPages.influencercart', compact('categories', 'incluencerdata', 'cities'));
    }
    ...
    public function allpartners()
    {
        ...
        $cities = DB::table('partners')
            ->select(DB::raw('LOWER(city) as city'))
            ->distinct()
            ->pluck('city');
        return view('AdminPanelPages.allpartnerspage', compact('partnersdata', 'partnerstypes', 'cities'));
    }
    ...
    {
        $categories = Master::where('type', 'Influencer')->get();
        return view('AdminPanelPages.addinfluencer', compact('categories'));
    }
    public function editinfluencer($id)
    {
        $data = Influencer::findOrFail($id);
        $categories = Master::where('type', 'Influencer')->get();
        return view('AdminPanelPages.editinfluencer', compact('categories', 'data'));
    }
}
